...
namespace BTickets.Migrations
{
    ...
    [Migration("20250830140445_OrderInitial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BTickets.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BTickets.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BTickets.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BTickets.Models.Order", b =>
                {
                    b.HasOne("BTickets.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BTickets.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("BTickets.Models.Order", "Order")
                        .WithMany("OrderItems")
